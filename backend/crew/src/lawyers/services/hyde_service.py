...
class HyDEService:
    ...
    def generate(self, issue: str, n: int = 3) -> List[str]:
        ...
        prompt = (
            ...
            f"văn bản LUẬT (Luật, Bộ luật, Hiến pháp) có thể áp dụng cho vấn đề. "
            f"Mỗi đoạn nên là một cụm từ tìm kiếm hiệu quả, không dài hơn 50 từ. "
            f"Tập trung vào luật Việt Nam và dùng tiếng Việt. "
            f"KHÔNG đề cập án lệ, bản án, quyết định tòa án, tài liệu tố tụng hay án lệ tương tự. "
            f"Chỉ tập trung vào luật, bộ luật, hiến pháp, điều luật và văn bản pháp luật.\n\n"
            f"Yêu cầu: {issue}"
        )
